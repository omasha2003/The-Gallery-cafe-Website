    ...
    <section>
        <nav class="navbar">
            <div class="navbar-content">
                <a href="../Components/staffhome.php">
        ...
        <nav class="secondary-navbar">
            <ul class="secondary-nav-links">
                <li><a href="../Pages/staffhome.php">ORDERS</a></li>
                <li><a href="../Pages/staffreservations.php">RESERVATION</a></li>
                <li><a href="../Pages/staffmenu.php">FOOD MENU</a></li>
            </ul>
        </nav>
    </section>
</body>
